...
import { LayoutDashboard, Users, Stethoscope, Bell, Settings, LogOut, User, Lock, Phone, X } from 'lucide-react'
...
export function Sidebar({ name, imageUrl }) {
  ...
  return (
    <>
      <div className="h-screen flex flex-col bg-green-900">
        ...
        <div className="p-4 border-sidebar-border">
          ...
          <button 
            ...
            className="cursor-pointer  cursor-pointer flex items-center gap-3 px-4 py-3 w-full rounded-lg text-sidebar-foreground hover:bg-green-700 transition-colors"
          >
            <LogOut size={20} />
      ...
      {/* Logout Confirmation Popup - No Background Overlay */}
      {showLogoutPopup && (
