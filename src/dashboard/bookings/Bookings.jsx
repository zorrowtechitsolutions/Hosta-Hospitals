...
// // //             <th className="text-left py-3 px-4 font-medium">Doctor & Specialty</th>
// // //             <th className="text-left py-3 px-4 font-medium">Booking Date & Time</th>
...
// // //   const handleStatusUpdate = async (bookingId, newStatus, bookingTime = null) => {
// // //     try {
// // //       const updateData = { status: newStatus }
      
// // //       // Add booking_time only when accepting and time is provided
// // //       if (newStatus === 'accepted' && bookingTime) {
...
// // //             <DialogDescription>
// // //               Enter the appointment time for {selectedBooking?.patient_name}'s booking with Dr. {selectedBooking?.doctor_name}
// // //             </DialogDescription>
// // //           </DialogHeader>
...
// // //                   Time set to: <span className="font-bold">{formatTimeToAMPM(manualTime)}</span>
// // //                 </p>
// // //                 <p className="text-xs text-green-600 mt-1">
// // //                   Will be stored as: {manualTime}
// // //                 </p>
// // //               </div>
// // //             )}
// // //           </div>
...
// // //             </Button>
// // //             <Button
// // //               onClick={() => handleStatusUpdate(selectedBooking._id, 'accepted', manualTime)}
// // //               disabled={!manualTime || isUpdating}
...
// //       // Add booking_time and update booking_date when accepting and time is provided
// //       if (newStatus === 'accepted' && bookingTime) {
// //         updateData.booking_time = bookingTime // Store as HH:MM format
        
// //         // Combine the existing booking_date with the new time
// //         const selectedBookingData = bookingData.data.find(booking => booking._id === bookingId);
// //         if (selectedBookingData) {
// //           updateData.booking_date = combineDateAndTime(selectedBookingData.booking_date, bookingTime);
// //         }
// //       }
...
// //                 </p>
// //                 <p className="text-xs text-green-600 mt-1">
// //                   Will update both booking time and date with time
// //                 </p>
// //               </div>
// //             )}
// //           </div>
