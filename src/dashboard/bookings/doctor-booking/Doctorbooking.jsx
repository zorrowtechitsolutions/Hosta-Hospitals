                ...
                <CardContent className="pt-0">
                  ...
                  <div className="mb-4">
                    ...
                    <div className="space-y-2 max-h-40 overflow-y-auto">
                      {doctor.consulting && doctor.consulting.length > 0 ? (
                        doctor.consulting.map((session, index) => (
                          <div key={index} className="text-xs">
                            <div className="font-medium text-gray-800 mb-1">{session.day}:</div>
                            <div className="space-y-1 ml-2">
                              {session.sessions && session.sessions.length > 0 ? (
                                session.sessions.map((sess, sessIndex) => (
                                  <div key={sessIndex} className="text-gray-600 flex justify-between">
                                    <span>
                                      {formatTimeToAMPM(sess.start_time)} - {formatTimeToAMPM(sess.end_time)}
                                    </span>
                                    {session.sessions.length > 1 && sessIndex < session.sessions.length - 1 && (
                        ...
                        <div className="text-xs text-gray-400">No consulting hours available</div>
                      )}
                    </div>
                  </div>
