...
// // import { DoctorDialog } from '@/components/dashboard/doctors/Doctor-dialog'
// // import { useGetAHospitalQuery } from '@/app/service/hospital'
// // import { useGetAllSpecialityQuery } from '@/app/service/specialites'
// // import { useAddAHospitalDoctorMutation, useDeleteAHospitalDoctorMutation, useUpdateAHospitalDoctorMutation } from '@/app/service/doctors'
...
// //     console.log(hospitalData, "hooosp");

// //     console.log(specialtiesData, "iiii");
...
//         }).unwrap()
//       } else {
//         // Add new doctor - find specialty ID by name
//         const specialty = hospitalData.data.specialties.find(
...
export default function DoctorsPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-green-800">Doctors</h1>
          <p className="text-muted-foreground mt-2">Manage your hospital doctors</p>
        </div>
        <Button
          onClick={() => {
